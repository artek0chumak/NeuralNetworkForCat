...
def nn_model(X, Y, layers_dims, num_iteration=10000, print_cost=False, learning_rate=0.002, keep_prob=1):
    ...
    for i in range(num_iteration):
        AL, caches = nn_under.forward_propagation(X, parameters, keep_prob)
